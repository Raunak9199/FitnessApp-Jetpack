...
fun GoogleFitSetupScreen(
    ...
    LaunchedEffect(Unit) {
        delay(500) // important
        hasPermissions = googleFitService.hasGoogleFitPermissions()
    ...
    val googleFitPermissionsLauncher = rememberLauncherForActivityResult(
        ...
        coroutineScope.launch {
            isLoading = true
            try {
                // ⏳ wait for Google Fit to persist permissions
                ...
                Card(
                    ...
                    Column(
                        ...
                        SetupStep(
                            ...
                            onAction = {
                                googleFitService.requestGoogleFitPermissions(
                                    activity,
                                    GoogleFitService.GOOGLE_FIT_PERMISSION_REQUEST_CODE
                                )
                            }
//                            onAction = {
//                                if (isGoogleSignedIn && !hasPermissions) {
